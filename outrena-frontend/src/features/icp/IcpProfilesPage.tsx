...
interface IcpProfile {
  ...
  createdAt: string;
  updatedAt: string;
  /** Populated by the list endpoint — count of prospects linked to this ICP. */
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {p.prospectCount != null && (
              <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-full text-[10px] font-medium bg-indigo-50 text-indigo-700 border border-indigo-200 shrink-0">
