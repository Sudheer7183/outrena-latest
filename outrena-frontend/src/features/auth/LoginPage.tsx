...
export function LoginPage() {
  ...
  // BUG-43: Dev identity options for login selector
  const DEV_IDENTITIES: { role: Role; label: string; email: string }[] = [
    { role: "SUPER_ADMIN",   label: "Super Admin",   email: "superadmin@outrena.com" },
    { role: "TENANT_ADMIN",  label: "Tenant Admin",  email: "admin@acme.com" },
    { role: "MANAGER",       label: "Manager",       email: "manager@acme.com" },
    { role: "REP",           label: "Rep",           email: "rep@acme.com" },
  ];
