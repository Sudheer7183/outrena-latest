...
// import { CampaignResultsPage } from "@/features/campaign_results/CampaignResultsPage";
...
//  * user is a SUPER_ADMIN, otherwise renders the fallback element (UserDashboardPage).
//  *
//  * Prevents SUPER_ADMIN from landing on "/" where the tenant dashboard fires API
//  * calls into per-tenant schemas that don't exist for the platform admin user
//  * (causing the "Dashboard failed to load — 404" error seen in the screenshot).
//  */
// function SuperAdminRedirect({ fallback }: { fallback: React.ReactNode }) {
//   const { user } = useAuth();
...
//           {
//             index: true,
//             element: <SuperAdminRedirect fallback={<UserDashboardPage />} />,
//           },
//         ],
//       },
//       {
...
//       },
//       // REP-gated feature pages (backend requires REP minimum)
//       {
//         element: <ProtectedRoute minimumRole="REP" />,
//         children: [
...
//           { path: "prospecting/job-change", element: <AlumniTrackerPage /> },
...
//           { path: "optimize/campaign-results", element: <CampaignResultsPage /> },
...
//           { path: "optimize/optimization-rules", element: <OptimizationRulesPage /> },
//           // Sender Identities + Usage — REP sees own data
...
//         element: <ProtectedRoute minimumRole="MANAGER" />,
//         children: [
//           { path: "prospecting/autopilot", element: <AutopilotPage /> },         // backend: MANAGER
//           { path: "prospecting/icp-profiles", element: <IcpProfilesPage /> },    // backend: MANAGER
//           { path: "prospecting/linkedin", element: <LinkedInPage /> },            // backend: MANAGER
//           { path: "outreach/exclusion-rules", element: <ExclusionRulesPage /> }, // backend: MANAGER (write)
//           { path: "setup/integrations", element: <IntegrationsPage /> },          // backend: MANAGER
//           { path: "setup/integration-config", element: <IntegrationConfigPage /> }, // backend: MANAGER
