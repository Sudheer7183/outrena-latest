...
//   mailbridge_api_key: string | null;
//   mailbridge_external_user_id: string | null;
//   createdAt: string;
//   updatedAt: string;
// }
...
// /** MailBridge platform registration response. */
// export interface MailBridgePlatformRegistration {
//   tenant_id: string;
//   name: string;
//   slug: string;
//   api_key: string;
...
// /** MailBridge connected mail account. */
// export interface MailBridgeMailAccount {
//   id: number;
...
// /** MailBridge OAuth connect-start response. */
// export interface MailBridgeConnectStart {
//   authorize_url: string;
//   state: string;
//   provider: string;
// }

// /** MailBridge email template. */
// export interface MailBridgeTemplate {
//   name: string;
//   subject: string;
//   body_html: string;
//   body_text: string;
...
// /** MailBridge tracking status for a single email. */
// export interface MailBridgeTrackingStatus {
//   message_id: string;
//   status: string;
//   provider: string;
//   opened: boolean;
...
//   // Backend returns list/dict (PG_JSON columns) — NOT strings
//   sourceSteps: Record<string, unknown>[];
//   enrichmentSteps: Record<string, unknown>[];
...
//   templateIcon?: string | null;
//   templateColor?: string | null;
//   // Send as list/dict to match backend ProspectingFlowCreate schema
//   sourceSteps?: Record<string, unknown>[];
//   enrichmentSteps?: Record<string, unknown>[];
//   qualityGates?: Record<string, unknown>;
// }
...
export interface SkipLogResponse {
  items: SkipLogItem[];
  total: number;
  reasonBreakdown: Record<string, number>;
}

export interface DailySentItem {
  campaignId: string;
  campaignName: string;
  sentDate: string;
  sentCount: number;
