"""
Feature campaigns — thin re-export of shared models.
...
"""
from app.models.campaign_models import Campaign, CampaignProspect  # noqa: F401
from app.models.config_models import Domain, LlmConfig, MailBridgeConfig  # noqa: F401
